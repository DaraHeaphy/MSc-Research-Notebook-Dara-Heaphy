...
stubs. My current aim is therefore to investigate whether an AI-assisted
feedback step can make embedded-C coverage reports more actionable, while
still manually checking whether any suggested changes are technically correct
and genuinely useful rather than relying on coverage improvement alone
\cite{inozemtseva2014}.
