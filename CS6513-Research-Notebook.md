...
**I forgot to mention in my last commit - these final 5 papers were reviewed over the course of the weekend Friday 7th - Sunday 9th August!**
...
### Week 07: Focus Area - Starting the Conference Paper Introduction

- **Activities Completed:** Over the weekend of Friday 14th to Sunday 16th August, I made a start on the introduction for the conference paper. I created a rough IEEE-style LaTeX structure using the official IEEE Conference Template on Overleaf as a guide, then drafted the opening context and added one early paragraph linking some of my studied literature to the research gap.
- **How the draft is developing:** I have kept this first version deliberately short. The opening introduces embedded software testing and code coverage, while the second paragraph brings in a small number of papers on coverage-guided LLM testing and embedded/C testing. I have also made an initial attempt at stating the gap around AI-assisted explanation of embedded-C coverage gaps and suggested tests, mocks, or stubs.
- **Plan for Next Step:** My next step is to restructure and expand the introduction so that the literature flows more clearly into the research gap, research question, proposed contribution, and final paper roadmap.
- **18/08/2026 - Introduction Expansion:** I expanded the initial conference-paper introduction in line with the plan from the previous update. I added a second literature-synthesis paragraph using HITS, Static Program Analysis Guided LLM Based Unit Test Generation, CodaMOSA, and ChatUniTest. This helped connect the literature more clearly around targeted context, difficult-to-cover code, coverage plateaus, and validation of generated tests.
- **How the argument has developed:** The introduction now has a clearer progression from the general embedded-testing context into existing LLM-based testing work, then into the specific research gap. I made the distinction clearer between recent LLM approaches, which are mostly evaluated outside embedded C, and established embedded-testing work, which already deals with hardware dependencies, abstraction layers, mocks, and stubs. I also added a citation to support the embedded-testing constraints discussed in the opening paragraph.
- **Research Question, Method, and Contribution:** I made the primary research question explicit in the paper and added a concise description of the planned evaluation process: collect baseline line, branch, and function coverage; provide selected uncovered regions and relevant context for analysis; review suggested tests, mocks, or stubs; compile and execute selected changes; and compare the results with the baseline. I also stated the intended contribution more directly as an evaluation of whether this feedback step can make embedded-C coverage reports more actionable while considering technical correctness and practical usefulness as well as raw coverage improvement.
- **Paper Structure:** I added the short roadmap paragraph required by the assignment. The current structure points to a methodology section, results section, and final discussion/conclusion section. I will make sure these section references still match the final manuscript once the rest of the paper is settled.
...
- **21/08/2026 - Final Refactor Before Submission:** I completed one final light refactoring pass on the conference-paper introduction before submission. Just making sure I was happy with what I had come up with over the past few weeks and ensuring that it was submission-ready. 
